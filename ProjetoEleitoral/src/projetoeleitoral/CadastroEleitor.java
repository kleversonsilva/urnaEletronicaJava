...
public class CadastroEleitor extends javax.swing.JFrame {
    ...
    public CadastroEleitor(Principal p, Funcionario f) {

        initComponents();
        this.p = p;
        this.f = f;
        this.eleitores1 = this.p.getEleitores();
    ...
    private void ButtonGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ButtonGravarActionPerformed
        ...
        // remete os dados para a classe Principal para gravação. Se gravou, retorna um True e fecha a tela.
        if (p.addEleitor(e)) {
            this.limparDados();
            e.clear();
